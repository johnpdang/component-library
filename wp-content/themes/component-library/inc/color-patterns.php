 ...
 */
function traina_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter traina default saturation level.
	 *
	 * @since traina 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'traina_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.traina-front-page) .entry-title,
...
.colors-custom .traina-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.traina-front-page .panel-content .recent-posts article,
...
.colors-custom.traina-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters traina custom colors CSS.
	 *
	 * @since traina 1.0
	 *
	 ...
	 */
	return apply_filters( 'traina_custom_colors_css', $css, $hue, $saturation );
}
